                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="shop_name" class="control-label">NGO Name</label>
                                <input type="text" id="shop_name" autofocus name="shop_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">NGO Representative Full Name</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="shop_type_id" class="control-label">NGO Type</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="logo" class="control-label">NGO Logo</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="vendor_id_photo" class="control-label">NGO ID Proof</label>
                                <input type="file" id="vendor_id_photo" name="id_proof" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/png, image/jpeg" required>
                            </div>
                        </div>
