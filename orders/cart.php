            ...
            <div id="cart-list">
                ...
                ?>
                    <div class="col-12 border">
                        <span>NGO: <b><?= $vrow['code']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3">&#8377<small class="text-primary"><?= format_num($prow['price']) ?></small></p></div>
                                </div>
                                <div class="d-flex">
