                ...
                <div class="col-md-8">
                    <form action="" id="checkout-form">
                        ...
                        <div class="form-group text-right">
                            <button class="btn btn-flat btn-default btn-sm bg-navy" action>Place Order</button>
                        </div>
                    </form>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="col-12 border">
                        ...
                        <div class="text-right h3" id='amt'><b><?= format_num($gtotal) ?></b></div>
                    </div>
                    </div>
                </div>
            </div>
...
<script>
    $('#checkout-form').submit(function(e){
        ...
        $.ajax({
            ...
            success:function pay_now(){
        var amt=jQuery('#amt').text();
